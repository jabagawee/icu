...
public class MeasureFormat extends UFormat {
    ...
    private static final class NumberFormatterCacheKey {
        ...
        public boolean equals(Object o) {
            ...
            if (!(o instanceof NumberFormatterCacheKey)) return false;
    ...
    // Replaces the old 3-entry MRU cache (formatter1/2/3) with a ConcurrentHashMap
    // for lock-free reads. The cache is bounded in practice by the number of distinct
    // (type, unit, perUnit) triples actually formatted by this instance, typically
    // a handful. The transient field is safe because MeasureFormat uses a serialization
    // proxy (MeasureProxy.readResolve) that constructs a fresh instance.
