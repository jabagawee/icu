...
public final class CharsetProviderICU extends CharsetProvider {
    ...
    /**
     * Constructs a Charset for the given charset name. Implements the abstract method of super
     * class.
     *
    ...
    public final Charset charsetForName(String charsetName) {
        try {
            ...
            if (charsetName.endsWith(UConverterConstants.OPTION_SWAP_LFNL_STRING)) {
                ...
                charsetName =
                        charsetName.substring(0, charsetName.length() - optionsString.length());
            }
     ...
     * Example use: <code>
     * cnv = CharsetProviderICU.charsetForName("myConverter", "com/myCompany/myDataPackage");</code>
     * . In this example myConverter.cnv would exist in the com/myCompany/myDataPackage Java
     * package. Conversion tables can be made with ICU4C's makeconv tool. This function allows you
     * to allows you to load user defined conversion tables that are outside of ICU's core data.
     *
    ...
    /**
     * Constructs a charset for the given ICU conversion table from the specified class path. This
     * function is similar to {@link #charsetForName(String, String)}.
     *
     * @param charsetName The name of the charset conversion table.
     * @param classPath The class path that contain the conversion table.
        ...
        try {
            if (enc != null) {
                if ((canonicalName = UConverterAlias.getCanonicalName(enc, "MIME")) != null) {
                    ret = canonicalName;
                } else if ((canonicalName = UConverterAlias.getCanonicalName(enc, "IANA"))
                        != null) {
                    ret = canonicalName;
    ...
    private static List<Charset> getAvailableICUCharsets() {
        return AvailableCharsetsHolder.INSTANCE;
    }

    /**
     * Returns an iterator for the available ICU Charsets. Implements the abstract method of super
     * class.
     *
